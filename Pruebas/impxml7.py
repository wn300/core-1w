...
VXML = {
    ...
    "SupplierAddress": find_element('.//cac:SenderParty/cac:PartyTaxScheme/cac:RegistrationAddress/cac:AddressLine/cbc:Line'),  # Ajustado aquí
    ...
    "CustomerAddress": find_element('.//cac:ReceiverParty/cac:PartyTaxScheme/cac:RegistrationAddress/cac:AddressLine/cbc:Line'),  # Ajustado aquí
