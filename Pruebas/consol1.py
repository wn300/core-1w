                                ...
                                for file in zip_ref.namelist():
                                    ...
                                    # Si es un XML, leer y procesar contenido
                                        ...
                                        try:
                                            ...
                                            # Agregar los datos a la lista de XML, incluyendo el CUFE
                                            xml_data.append([asunto, remitente, fecha, xml_content_str, CUFE])
                                        except Exception as e:
