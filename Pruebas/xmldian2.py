...
VXML = {
    ...
    # Detalles de Producto (CreditNoteLine)
    ...
    "ItemLotNumberID": ".//cac:ItemInstance/cac:LotIdentification/cbc:LotNumberID",  # Ajuste para uso de // con ElementTree
    "ItemExpiryDate": ".//cac:ItemInstance/cac:LotIdentification/cbc:ExpiryDate",
...
def parse_xml_and_extract_values(xml_file, dictionary):
    ...
    for key, path in dictionary.items():
        ...
        results[key] = element.text if element is not None else "<nodisponibles>"
